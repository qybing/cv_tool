...
if __name__ == '__main__':
    '''
    本脚本是VOC数据集转百度训练的coco数据集格式
    python tools/x2coco.py \
        --dataset_type voc \
        --voc_anno_dir /xx/xx/xx/xx/xxx/xx/Annotations \
        --voc_anno_list /xx/xx/xx/xx/xxx/xxx/ImageSets/Main/val.txt \
        --voc_label_list /xx/xx/xx/xx/xxx/xxx/label_list.txt \
